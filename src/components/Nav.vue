	...
	<header id="header">
		<nav class="mobileNav">
			<router-link :to="{name:'index'}" >
				<!-- <img src="../assets/jishuboketitle.svg" alt=""> -->
	...
	<path fill="#333333" d="M111.783,4.021h4.407l-0.217,1.369h2.249l-0.662,4.176h-2.342l2.078,1.669l-2.341,14.775l-2.644-1.902
		...
		<nav class="nav">
			<ul>
				...
				<router-link :to="{name:'index'}" tag="li"  >主页</router-link>
				<router-link :to="{name:'qianduanlist'} " tag="li" >前端</router-link>
				<router-link :to="{name:'houduanlist'} " tag="li" >后端</router-link>
				<router-link :to="{name:'designlist'} " tag="li" >设计</router-link>
